...
# Generated on: Thu May 04 16:18:06 IST 2023 (Thu May 04 10:48:06 UTC 2023)
...
#set_log_file write_lec_generate_label.1_mapped_netlist1v.log -replace

usage -auto -elapse

set_verification_information write_lec_generate_label.1_mapped_netlist1v_db
...
# both designs.
#read_implementation_information fv/async_fifo1 -golden write_lec_generate_label.1 -revised mapped_netlist1v
...
read_library -liberty -both /home/msis/Documents/nagaraj/project/new/new5/library/fast.lib

read_design -sv   -golden -lastmod -noelab ./rtl/design.v
elaborate_design -golden -root {async_fifo1}

read_design -verilog95   -revised -lastmod -noelab ./mapped/mapped_netlist1.v
elaborate_design -revised -root {async_fifo1}

#add_name_alias fv/async_fifo1/mapped_netlist1v.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/async_fifo1/mapped_netlist1v.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
#analyze_results -logfiles write_lec_generate_label.1_mapped_netlist1v.log
}
